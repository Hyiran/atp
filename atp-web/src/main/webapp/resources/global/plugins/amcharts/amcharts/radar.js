(function () {
    ...
    c.AmRadarChart = c.Class({
        inherits: c.AmCoordinateChart, construct: function (a) {
            ...
            var a = this.updateWidth(), b = this.updateHeight(), d = this.marginTop + this.getTitleHeight(), f = this.marginLeft, k = this.marginBottom, l = this.marginRight, e = b - d - k;
        ...
        construct: function (a) {
            ...
            if (b) {
                ...
                for (w = 0; w < A; w++) {
                    ...
                    var v = l + this.axisWidth * Math.sin(t / 180 * Math.PI), t = e + this.axisWidth * Math.cos(t / 180 * Math.PI);
                    0 < k && (v = c.line(b.container, [l, v], [e, t], f, k, d), this.set.push(v), c.setCN(b, v, a.bcn + "line"));
                    if (g) {
                        var B = "start", v = l + (n + p) * Math.sin(q / 180 * Math.PI), t = e + (n + p) * Math.cos(q / 180 * Math.PI);
...
(function () {
    ...
    c.RadItem = c.Class({
        construct: function (a, b, d, f, k, l, e, p) {
            ...
            this.set = k = r.set();
            var u = a.axisColor, A = a.axisAlpha, w = a.tickLength, n = a.gridAlpha, t = a.gridThickness, q = a.gridColor, v = a.dashLength, B = a.fillColor, E = a.fillAlpha, G = a.labelsEnabled;
            l = a.counter;
