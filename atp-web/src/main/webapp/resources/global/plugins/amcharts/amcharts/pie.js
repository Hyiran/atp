        ...
        inherits: l.AmSlicedChart, construct: function (d) {
            ...
            if (l.ifArray(d)) {
                if (0 < this.realWidth && 0 < this.realHeight) {
                    ...
                    this.realHeight = n;
                    var e = l.toCoordinate, f = e(this.marginLeft, b), a = e(this.marginRight, b), v = e(this.marginTop, n) + this.getTitleHeight(), m = e(this.marginBottom, n), A, B, k, y = l.toNumber(this.labelRadius), p =
                    ...
                    for (var D, f = 0; f < d.length; f++)if (a = d[f], !0 !== a.hidden && (this.showZeroSlices || 0 !== a.percents)) {
                        ...
                        if (this.labelsEnabled && this.labelText && a.percents >= this.hideLabelsPercent) {
                            ...
                            if ("" !== h) {
                                ...
                                a.ty = E;
                                a.textX = t + 1.5 * u;
                                var r = h.getBBox(), F = l.rect(c, r.width +
            ...
            for (b = g - 1; 0 <= b; b--)c = d[b], 0 !== c.labelQuarter || c.hidden || this.checkOverlapping(b, c, 0,
                !0, 0);
            ...
            if (m) {
                if (!0 === b)for (f = d + 1; f < v; f++)a[f].labelQuarter == c && (e = this.checkOverlappingReal(g, a[f], c)) && (f = v); else for (f = d - 1; 0 <= f; f--)a[f].labelQuarter == c && (e =
