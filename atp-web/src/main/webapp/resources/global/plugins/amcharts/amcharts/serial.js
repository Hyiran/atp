        ...
        updateAfterValueZoom: function () {
            ...
            if (b) {
                var c = ["value", "open", "low", "high", "close"], d = "value open low high close average sum count".split(" "),
                    f = b.valueAxis, h = this.chartData, g = b.numberFormatter;
                g || (g = this.nf);
...
(function () {
    ...
    e.Cuboid = e.Class({
        construct: function (a, b, c, d, e, h, g, k, m, l, p, q, n, x, y, w, r) {
            ...
            if (0 < Math.abs(h) || 0 < Math.abs(g))if (isNaN(r))F = v, v = e.adjustLuminosity(A, -.2), v = e.adjustLuminosity(A, -.2), u = e.polygon(b, [0, h, d + h, d, 0], [0, g, g, 0, 0],
            ...
            d = isNaN(r) ? 0 > f ? [u,
                M, B, C, I, z, D, F, L, b] : [F, L, B, C, I, z, u, M, D, b] : K ? 0 < d ? [u, b, F] : [F, b, u] : 0 > f ? [u, b, F] : [F, b, u];
            e.setCN(c, b, t + "front");
            e.setCN(c, B, t + "back");
            e.setCN(c, F, t + "top");
    ...
    e.CategoryAxis = e.Class({
        inherits: e.AxisBase, construct: function (a) {
            ...
            if (e.ifArray(a)) {
                ...
                var d = this.start, f = this.labelFrequency, h = 0, g = this.end - d + 1, k = this.gridCountR, m = this.showFirstLabel, l = this.showLastLabel, p, q, n = "", n = e.extractPeriod(this.minPeriod), x = e.getPeriodDuration(n.period,
                    n.count), y, w, r, t;
                y = this.rotate;
