...
<head>
    ...
    <link href="${ctx}/resources/global/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css" rel="stylesheet" type="text/css" />
    <link href="${ctx}/resources/global/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet" type="text/css" />
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="tab_images">
                                                ...
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="${ctx}/resources/pages/media/works/img1.jpg" class="fancybox-button" data-rel="fancybox-button">
                                                                <img class="img-responsive" src="${ctx}/resources/pages/media/works/img1.jpg" alt=""> </a>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="${ctx}/resources/pages/media/works/img2.jpg" class="fancybox-button" data-rel="fancybox-button">
                                                                <img class="img-responsive" src="${ctx}/resources/pages/media/works/img2.jpg" alt=""> </a>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="${ctx}/resources/pages/media/works/img3.jpg" class="fancybox-button" data-rel="fancybox-button">
                                                                <img class="img-responsive" src="${ctx}/resources/pages/media/works/img3.jpg" alt=""> </a>
                                                        </td>
                                                        <td>
...
<script src="${ctx}/resources/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
<script src="${ctx}/resources/global/plugins/bootstrap-maxlength/bootstrap-maxlength.min.js" type="text/javascript"></script>
