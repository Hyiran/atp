...
<head>
    ...
    <!-- END THEME STYLES -->
    <link rel="shortcut icon" href="<%basePath%>assets/app/img/favicon.ico"/>
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body class="login">
<!-- BEGIN LOGO -->
<div class="logo">
    <img src="<%basePath%>assets/img/logo-big.png" alt=""/>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    ...
    <form class="register-form" action="login.jsp" method="post">
        ...
        <div class="form-group">
            ...
            <select name="country" id="select2_sample4" class="select2 form-control" title="国家">
                <option value=""></option>
...
<%--<script src="../../<%basePath%>assets/app/lib/security/sha256.js" type="text/javascript"></script>--%>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
